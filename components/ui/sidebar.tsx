...
type SidebarContextProps = {
    ...
    isMobile: boolean;
    toggleSidebar: () => void;
    // Add left/right sidebar state and toggles
...
function SidebarProvider({
    ...
    // Add separate state for left and right sidebars
...
function Sidebar({
    ...
    // Determine if this sidebar should be open (desktop)
    const isOpen =
...
function SidebarTrigger({
    className,
    onClick,
    side = 'left', // Add side prop, default to left
    ...props
    ...
    return (
        ...
        >
            ...
            <span className="sr-only">
                Toggle {side === 'right' ? 'Right' : 'Left'} Sidebar
            </span>
        </Button>
    );
}
