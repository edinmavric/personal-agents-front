        ...
        <div className="h-14 border-b flex items-center justify-between px-6 shrink-0 relative z-10 bg-background/80 backdrop-blur-sm">
          <div className="flex items-center gap-4">
            <Select
              ...
              onValueChange={(value) =>
                setSelectedAgentId(value ? parseInt(value, 10) : null)
              }
            ...
            >
              <SelectTrigger className="w-[250px] h-9 pl-2 pr-3">
                <SelectValue
                  placeholder={
                    isLoadingAgents ? "Loading agents..." : "Select a chat"
                  }
                >
                  {selectedAgent ? (
                    <div className="flex items-center gap-2">
                      <Avatar className="h-6 w-6">
                        ...
                        />
                        <AvatarFallback>
                          {selectedAgent.appearance?.iconInitial || (
                            <Bot size={12} />
                          )}
                        </AvatarFallback>
                      </Avatar>
              ...
              {isLoadingHistory ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center py-20">
                  ...
                  <p className="text-muted-foreground mt-2 max-w-md">
                    Choose an agent from the sidebar or header dropdown to start
                    chatting.
                  </p>
                </div>
